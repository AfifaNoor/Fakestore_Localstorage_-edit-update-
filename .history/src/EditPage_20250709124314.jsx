  ...
  return (
    ...
    {edit.map((item)=>(
     ...
     <form className="right-container">
            <input className="input-field" value={item.title} />
            <input className="input-field" value ={item.price} placeholder='$'/>
            <input className="input-field" value ={item.category} placeholder='Category:'/>
