  ...
  return (
    ...
    {edit.map((item)=>(
     ...
     <form className="right-container">
            ...
            <input className="input-field" type='text'  value={item.title} />
            <input className="input-field" name='price' text='number' value ={item.price} placeholder='$'/>
            <input className="input-field" type='text'   value ={item.category} placeholder='Category:'/>
